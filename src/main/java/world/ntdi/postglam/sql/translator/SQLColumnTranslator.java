...
public class SQLColumnTranslator {
     ...
     */
    public Object[] columnValuesTranslate(@NonNull final Table table, @NonNull final Map.Entry<String, DataTypes> column, Column.Ordering ordering) throws SQLException {
        LinkedList<Object> values = new LinkedList<>();

        ResultSet resultSet = table.getDatabase().getStmt().executeQuery(
                "SELECT " + column.getKey() +
